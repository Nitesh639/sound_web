/** [p5.sound]  Version: 1.0.1 - 2022-11-30 */ 
 /**
...
function () {
 ...
 soundfile_createClass(SoundFile, [{
   ...
   key: "trime",
   value: function trime(startTime, endTime) {
     if (startTime < 0 || startTime > this.buffer.duration) {
       throw 'start time out of range';
     }

     if (endTime > this.buffer.duration) {
       throw 'end time out of range';
     }

     if (startTime > endTime) {
       throw 'end time is less than start time';
     }

     var sTime = startTime || 0;
     var dur = endTime - startTime || undefined;

     if (this.isPlaying()) {
       this.stop(0);
       this.play(0, this.playbackRate, this.output.gain.value, sTime, dur);
     }
   }
   /**
